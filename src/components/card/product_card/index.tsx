...
export default function ProductCard({
  ...
  return (
    <div className="flex justify-center">
      <div className="bg-white w-[15.375rem] h-[24rem]">
        ...
        <section className="px-2 py-6 space-y-3">
          ...
          <div className="flex space-x-2 items-center">
            {isNegotiable && <p className="text-primary font-gendra text-lg">${price}</p>}
            {isNegotiable && (
              <>
                <CiPercent className="text-surface-icons w-5 h-5" />
          ...
          <div className="flex space-x-2 items-center">
            <CiLocationOn className="w-4 h-4 text-surface-icons" />
